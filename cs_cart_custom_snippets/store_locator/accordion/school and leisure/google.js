...
$(document).ready(function () {
 ...
 // Data queries
$('*[data-location="Wynberg"]').appendTo('#wynberg');
$('*[data-location="Boksburg"]').appendTo('#boksburg');
$('*[data-location="Cresta"]').appendTo('#cresta');
$('*[data-location="Rondebosch"]').appendTo('#rondebosch');
$('*[data-location="Willowbridge"]').appendTo('#willowbridge');
